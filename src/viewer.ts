  ...
  return layout({
    body: `
      ...
      <section>
        ...
        ${renderCommand("Backfill CSS dependencies", "bun run assets:backfill -- --css-deps --limit 100 --delay-ms 2000 --asset-depth 2")}
        ${renderCommand("Backfill newest post assets", "bun run assets:backfill -- --latest-pages --rounds 50 --limit 50 --delay-ms 2000 --asset-depth 2")}
